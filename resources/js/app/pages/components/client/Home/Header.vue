<template>
    <section class="homeHeader">
        ...
        <div class="text-box">
            ...
            <p> Find the right training for you!<br>The growth in the number of students, faculty, partnerships and many other indicators bear witness to the evolution of ENET'COM</p>
...
.homeHeader {
    min-height: 100vh;
    width: 100%;
    background-image: linear-gradient(rgba(4, 9, 30, 0.7), rgba(4, 9, 30, 0.7)), url('/images/client/slide1.jpg'); 
